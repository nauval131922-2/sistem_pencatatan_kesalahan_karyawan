...
export function CardSkeleton() {
  return (
    <div className="bg-white border border-gray-100 p-5 rounded-2xl shadow-sm animate-pulse">
...
export function ChartSkeleton({ height = "400px" }: { height?: string }) {
  return (
    <div className={`bg-white border border-gray-100 p-6 rounded-2xl shadow-sm animate-pulse flex flex-col`} style={{ minHeight: height }}>
...
export function InsightSkeleton() {
  return (
    <div className="bg-gray-100 border border-gray-100 p-8 rounded-3xl animate-pulse flex flex-col items-center text-center justify-center min-h-[400px]">
      <div className="w-16 h-16 bg-white/50 rounded-2xl mb-6"></div>
      <div className="h-6 w-48 bg-white/50 rounded-lg mb-4"></div>
