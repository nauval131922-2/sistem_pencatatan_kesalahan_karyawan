...
export default function BarangJadiClient() {
  ...
  const stopResizing = useCallback(() => {
    ...
    // isResizingDone.current = true; // This line was removed as it was not in the provided snippet
    // setTimeout(() => { isResizingDone.current = false; }, 100); // This line was removed as it was not in the provided snippet
