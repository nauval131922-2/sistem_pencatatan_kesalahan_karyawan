...
export default function MasterPekerjaanUpload() {
  ...
  return (
    <div className="h-full shrink-0 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="bg-white rounded-[8px] border-[1.5px] border-gray-200 p-5 hover:border-gray-200 hover:shadow-sm transition-all duration-300 flex items-center justify-between gap-4 relative z-50 h-[97px]">
