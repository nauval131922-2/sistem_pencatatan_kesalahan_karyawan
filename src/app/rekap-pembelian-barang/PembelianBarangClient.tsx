    ...
    <div className="flex-1 min-h-0 flex flex-col gap-5 animate-in fade-in duration-500 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-4 overflow-hidden min-h-0 relative">
        ...
        <div className="flex-1 min-h-0 flex flex-col gap-4 overflow-hidden">
          ...
          <TableFooter totalCount={totalCount} currentCount={data?.length || 0} label="data Laporan Rekap Pembelian Barang" selectedCount={selectedIds.size} onClearSelection={clearSelection} loadTime={loadTime} />
        </div>
      </div>
