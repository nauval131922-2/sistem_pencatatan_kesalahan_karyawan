  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      cell: ({ getValue }: any) => {
        ...
        return (
          <span className={`font-black text-[10px] px-2 py-0.5 border-[2px] border-black shadow-[1.5px_1.5px_0_0_#000] uppercase ${isClosed ? 'bg-gray-200 text-gray-500' : 'bg-[#22c55e] text-white'}`}>
            {val || 'OPEN'}
          </span>
        );
      }
