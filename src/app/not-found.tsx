  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[80vh] bg-transparent p-6 text-center animate-in fade-in duration-500">
      <div className="relative mb-8">
        <div className="relative w-28 h-28 bg-[#fde047] border-[4px] border-black shadow-[8px_8px_0_0_#000] flex items-center justify-center mx-auto">
      ...
      <div className="mt-3 inline-block border-[3px] border-black bg-[var(--accent-primary)] px-4 py-1 shadow-[4px_4px_0_0_#000]">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-10">
        <button 
          ...
          className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-none border-[3px] border-black text-sm font-black text-black bg-white hover:bg-[#fde047] transition-all shadow-[4px_4px_0_0_#000] hover:shadow-[6px_6px_0_0_#000] hover:-translate-y-[2px] hover:-translate-x-[2px] active:translate-y-[2px] active:translate-x-[2px] active:shadow-none uppercase"
        >
