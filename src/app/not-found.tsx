  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[80vh] bg-transparent p-6 text-center animate-in fade-in duration-500">
      <div className="relative mb-8">
        <div className="relative w-24 h-24 bg-white rounded-[20px] shadow-sm flex items-center justify-center border border-gray-100 mx-auto">
      ...
      <div className="mt-16 text-[11px] font-bold text-gray-300">
